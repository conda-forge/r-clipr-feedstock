...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-clipr-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-clipr-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-clipr-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-clipr-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-clipr-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-clipr-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-clipr` can be installed with:

```
conda install r-clipr
```

It is possible to list all of the versions of `r-clipr` available on your platform with:
